...
const account1 = {
  ...
  movementsDates: [
    ...
    "2022-08-13T23:36:17.929Z",
    "2022-08-15T10:51:36.790Z"
  ],
  currency: "EUR",
  locale: "pt-PT" // de-DE
};
...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    // looping 2 array at the same time
...
// console.log(arr.slice(-2)); // the last 2 element
// console.log(arr.slice(1, -2)); // position 1 and omit last 2 ['b', 'c']
// console.log(arr.slice());
// console.log([...arr]);

// SPLICE
// console.log(arr.splice(2)); // mutate the original array
// arr.splice(-1);
// console.log(arr);
// arr.splice(1, 2);
// console.log(arr); // ['a', 'b']
...
// console.log(arr.slice(-1)[0]); // remove array element
...
//   const dogCorrected = dog1.splice(1, 2);

//   const totalDogs = dogCorrected.concat(dog2);
...
// Your tasks:
// Create a function 'calcAverageHumanAge', which accepts an arrays of dogs ages('ages'), and does the following
// things in order:
...
// Coding Challenge #3
// Rewrite the 'calcAverageHumanAge' function from previous challenge, but this time as an
...
// flatmap - cannot work on nested array
...
// console.log(owners.sort()); //mutated
// console.log(owners);

// Numbers
// console.log(movements); // [200, 450, -400, 3000, -650, -130, 70, 1300]
// console.log(movements.sort()); // doesnt work on numbers  [-130, -400, -650, 1300, 200, 3000, 450, 70]
...
// let a = 10;
// console.log(a++); // doesnt return the plus value but the existing one
// console.log(a); // 11
// console.log(a + 1); // 12
...
and eating too little is the opposite. Eating an okay amount means the dog's current food portion 
...
1. Loop over the 'dogs' array containing dog objects, and for each dog, calculate the recommended 
   ...
   over the array. Formula: recommendedFood = weight ** 0.75 * 28. (The result is in grams of food, 
...
8. Create a shallow copy of the 'dogs' array and sort it by recommended food portion in an 
   ...
   current < (recommended * 1.10). Basically, the current portion should be between 90% and 110% of 
...
// const recomendedFood = (dogWeight) => {
//   const totalFood = dogWeight.map((data, i) => ({
//     ...data,
//     recFood: data.weight ** 0.75 * 28
//   }));
//   const sarahDog = totalFood.find((name, i, arr) => name.owners[0] === "Sarah")
...
// console.log(Number.parseFloat("2.5rem")); // 2.5 --> recommended!
...
// console.log(randomInt(10, 20)); // within 10 to 20 range
...
// // Rounding decimals
// console.log(typeof (2.7).toFixed(0)); // 3 ! return to string not a number
...
// console.log(new Date("Aug 18 2022 09:50:02"));
// console.log(new Date("December 24, 2015"));
// console.log(new Date(account1.movementsDates[0]));

// console.log(new Date(2037, 10, 19, 15, 23, 5)); // Thu Nov 19 2037 15:23:05 GMT+0800 (Malaysia Time) * month is zero based
// console.log(new Date(2037, 10, 31)); // Tue Dec 01 2037 00:00:00 GMT+0800 (Malaysia Time)
// console.log(new Date(0)); // Thu Jan 01 1970 07:30:00 GMT+0730 (Malaysia Time)
// // days * hours * min * sec * milliseconds
// console.log(new Date(3 * 24 * 60 * 60 * 1000)); // Sun Jan 04 1970 07:30:00 GMT+0730 (Malaysia Time)
...
// console.log(Date.now()); // 1660788088768
// future.setFullYear(2040);
// console.log(future); // Mon Nov 19 2040 15:23:00 GMT+0800 (Malaysia Time)
